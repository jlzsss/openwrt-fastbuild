...
setup_envs() {
  ...
  _set_env OPENWRT_COMPILE_DIR OPENWRT_SOURCE_DIR OPENWRT_CUR_DIR FORCE_UNSAFE_CONFIGURE FORCE
...
update_builder_info() {
  ...
  OPT_REBASE="0"
  OPT_DEBUG="0"
  _set_env OPT_PUSH_WHEN_FAIL OPT_PACKAGE_ONLY OPT_UPDATE_FEEDS OPT_UPDATE_REPO OPT_REBUILD OPT_REBASE OPT_DEBUG
